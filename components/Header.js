                ...
                <Image 
                   ...
                   /> 
                    <form className="flex flex-grow px-6 py-3 ml-10 mr-5 border border-gray-200 rounded-full shadow-lg max-w-3xl items-center">
                       ...
                       <SearchIcon className="h-6 hidden sm:inline-flex text-blue-500 border-gray-300 cursor-pointer"/>
                       <button hidden type="submit"
                        onClick={search}>Search</button>
                    </form>
                   
                    {/* Avatar */}
                    <Avatar className="ml-auto" url="https://media-exp1.licdn.com/dms/image/C5103AQFE74YaU-0acA/profile-displayphoto-shrink_200_200/0/1521792249204?e=1622678400&v=beta&t=Cc5IXcaFqMd6wMtQa1qt5gEadWImnLlV6SkK5Dxdc5I" />
            </div>
